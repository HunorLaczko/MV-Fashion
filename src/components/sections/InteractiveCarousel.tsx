...
const CATEGORY_IMAGES: Record<string, string[]> = {
    "Outfits": [
        withBasePath('/images/carousel/outfits/outfits_1.webp'),
        withBasePath('/images/carousel/outfits/outfits_2.webp'),
        withBasePath('/images/carousel/outfits/outfits_3.webp'),
        withBasePath('/images/carousel/outfits/outfits_4.webp'),
        withBasePath('/images/carousel/outfits/outfits_5.webp'),
        withBasePath('/images/carousel/outfits/outfits_6.webp'),
        withBasePath('/images/carousel/outfits/outfits_7.webp'),
        withBasePath('/images/carousel/outfits/outfits_8.webp'),
        withBasePath('/images/carousel/outfits/outfits_9.webp'),
        withBasePath('/images/carousel/outfits/outfits_10.webp'),
    ],
    "Multiview": [
        withBasePath('/images/carousel/multiview/multiview_1.webp'),
        withBasePath('/images/carousel/multiview/multiview_2.webp'),
        withBasePath('/images/carousel/multiview/multiview_3.webp'),
        withBasePath('/images/carousel/multiview/multiview_4.webp'),
        withBasePath('/images/carousel/multiview/multiview_5.webp'),
        withBasePath('/images/carousel/multiview/multiview_6.webp'),
        withBasePath('/images/carousel/multiview/multiview_7.webp'),
        withBasePath('/images/carousel/multiview/multiview_8.webp'),
        withBasePath('/images/carousel/multiview/multiview_9.webp'),
        withBasePath('/images/carousel/multiview/multiview_10.webp'),
        withBasePath('/images/carousel/multiview/multiview_11.webp'),
        withBasePath('/images/carousel/multiview/multiview_12.webp'),
    ],
    "Poses": [
        withBasePath('/images/carousel/poses/poses_1.webp'),
        withBasePath('/images/carousel/poses/poses_2.webp'),
        withBasePath('/images/carousel/poses/poses_3.webp'),
        withBasePath('/images/carousel/poses/poses_4.webp'),
        withBasePath('/images/carousel/poses/poses_5.webp'),
        withBasePath('/images/carousel/poses/poses_6.webp'),
        withBasePath('/images/carousel/poses/poses_7.webp'),
        withBasePath('/images/carousel/poses/poses_8.webp'),
        withBasePath('/images/carousel/poses/poses_9.webp'),
        withBasePath('/images/carousel/poses/poses_10.webp'),
    ],
};
